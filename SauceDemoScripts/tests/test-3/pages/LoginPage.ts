...
export class LoginPage {
  ...
  constructor(private readonly page: Page) {
    ...
    // this.loginButton = page.getByTestId('login-button');                  // data-testid
    ...
    // Error message — uncomment the line that matches your app's DOM:
    // this.errorMessage = page.getByRole('alert');                          // role (preferred)
    // this.errorMessage = page.getByTestId('error-message-container');      // data-testid
    // this.errorMessage = page.locator('[data-test="error"]');             // data-test attribute
    // this.errorMessage = page.locator('.error-message-container');         // CSS class
    this.errorMessage = page.locator('[data-test="error"]');                // ← active (best guess — verify in DevTools)
  }
